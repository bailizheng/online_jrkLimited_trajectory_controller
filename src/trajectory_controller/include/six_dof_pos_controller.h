...
#ifndef RTW_HEADER_six_dof_pos_controller_h_
#define RTW_HEADER_six_dof_pos_controller_h_
#include <string.h>
#include <float.h>
#include <stddef.h>
#include "rtw_modelmap.h"
#ifndef six_dof_pos_controller_COMMON_INCLUDES_
# define six_dof_pos_controller_COMMON_INCLUDES_
#include "rtwtypes.h"
#include "rtw_continuous.h"
#include "rtw_solver.h"
#include "rt_logging.h"
#endif                                 /* six_dof_pos_controller_COMMON_INCLUDES_ */

#include "six_dof_pos_controller_types.h"
...
typedef struct {
  real_T q;                            /* '<S2>/Saturation2' */
  real_T q_b;                          /* '<S3>/Saturation6' */
  real_T q_h;                          /* '<S1>/Saturation6' */
  real_T q_c;                          /* '<S4>/Saturation6' */
  real_T q_hd;                         /* '<S5>/Saturation6' */
  real_T q_j;                          /* '<S6>/Saturation6' */
...
} ExtY_six_dof_pos_controller_T;

/* Parameters (default storage) */
struct P_six_dof_pos_controller_T_ {
  ...
  real_T Delay4_InitialCondition;      /* Expression: 0
                                        ...
                                        */
  real_T Delay6_InitialCondition_p;    /* Expression: 0
  ...
  real_T Delay4_InitialCondition_j;    /* Expression: 0
                                        ...
                                        */
  real_T Delay6_InitialCondition_k;    /* Expression: 0
  ...
  real_T Delay4_InitialCondition_n;    /* Expression: 0
                                        ...
                                        */
  real_T Delay6_InitialCondition_ok;   /* Expression: 0
                                        * Referenced by: '<S6>/Delay6'
                                        */
  ...
  uint32_T Delay4_DelayLength;         /* Computed Parameter: Delay4_DelayLength
                                        * Referenced by: '<S3>/Delay4'
                                        */
  uint32_T Delay6_DelayLength_c;       /* Computed Parameter: Delay6_DelayLength_c
                                        * Referenced by: '<S1>/Delay6'
                                        */
  ...
  uint32_T Delay4_DelayLength_l;       /* Computed Parameter: Delay4_DelayLength_l
                                        * Referenced by: '<S1>/Delay4'
                                        */
  uint32_T Delay6_DelayLength_n;       /* Computed Parameter: Delay6_DelayLength_n
                                        * Referenced by: '<S4>/Delay6'
                                        */
  ...
  uint32_T Delay4_DelayLength_d;       /* Computed Parameter: Delay4_DelayLength_d
                                        * Referenced by: '<S4>/Delay4'
                                        */
  uint32_T Delay6_DelayLength_p;       /* Computed Parameter: Delay6_DelayLength_p
                                        * Referenced by: '<S5>/Delay6'
                                        */
...
struct tag_RTM_six_dof_pos_controlle_T {
  const char_T *errorStatus;
  RTWLogInfo *rtwLogInfo;
  RTWSolverInfo solverInfo;
  X_six_dof_pos_controller_T *contStates;
...
extern "C" {
  ...
  extern P_six_dof_pos_controller_T six_dof_pos_controller_P;
...
/* Block signals (default storage) */
extern B_six_dof_pos_controller_T six_dof_pos_controller_B;

/* Continuous states (default storage) */
extern X_six_dof_pos_controller_T six_dof_pos_controller_X;

/* Block states (default storage) */
extern DW_six_dof_pos_controller_T six_dof_pos_controller_DW;
...
extern "C" {
  ...
  /* External inputs (root inport signals with default storage) */
  extern ExtU_six_dof_pos_controller_T six_dof_pos_controller_U;

  /* External outputs (root outports fed by signals with default storage) */
  extern ExtY_six_dof_pos_controller_T six_dof_pos_controller_Y;
...
extern "C" {
  ...
  extern void six_dof_pos_controller_initialize(void);
  extern void six_dof_pos_controller_step(void);
  extern void six_dof_pos_controller_terminate(void);
...
extern "C" {
  ...
  extern RT_MODEL_six_dof_pos_controll_T *const six_dof_pos_controller_M;
 ...
 *
 * '<Root>' : 'six_dof_pos_controller'
 * '<S1>'   : 'six_dof_pos_controller/joint 2'
 * '<S2>'   : 'six_dof_pos_controller/joint_0'
 * '<S3>'   : 'six_dof_pos_controller/joint_1 '
 * '<S4>'   : 'six_dof_pos_controller/joint_3'
 * '<S5>'   : 'six_dof_pos_controller/joint_4  '
 * '<S6>'   : 'six_dof_pos_controller/joint_5'
 */
#endif                                 /* RTW_HEADER_six_dof_pos_controller_h_ */
